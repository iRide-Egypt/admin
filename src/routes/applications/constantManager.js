...
const docRef = db.collection("app").doc("constants");
let timer;
class ConstantManager extends Component {
  state = {
  ...
  addPost() {
    ...
    docRef
      .update({
        programs: firebase.firestore.FieldValue.arrayUnion(item),
      })
      .then(() => {
        this.setPostsList();
  ...
  deletePost(id) {
    ...
    docRef
      .update({
        programs: firebase.firestore.FieldValue.arrayRemove(item),
      })
      .then(() => {
        this.setPostsList();
      })
          ...
          <Colxx xxs="12">
            <div className="mb-2">
              ...
              <div className="float-sm-right">
                ...
                >
                  <IntlMessages id="Add New Constant" />
                </Button>
                <Modal
